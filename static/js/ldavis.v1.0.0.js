...
export function LDAvis(to_select, data_or_file_name) {
    ...
    var margin = {
        ...
        mdswidth = $("#" + "ldavis_third_id").width()/2-100,
        mdsheight = 530,
        barwidth = $("#" + "ldavis_third_id").width()/2-100 - 180,
        barheight = 530,
        termwidth = 180, // width to add between two panels to display terms
    ...
    function visualize(data) {
        ...
        var svg = d3.select(to_select).append("svg")
            ...
            .attr("width", $("#" + "ldavis_third_id").width() -50)
        ...
        function init_forms(topicID, lambdaID, visID) {
            ...
            inputDiv.setAttribute("style", "width:" + $("#" + "ldavis_third_id").width()-50 + "px"); // to match the width of the main svg element
            document.getElementById(visID).appendChild(inputDiv);

            // topic input container:
            var topicDiv = document.createElement("div");
            topicDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; width: 50%; height: 50px; float: left");
            ...
            topicLabel.innerHTML = "选择主题: <span id='" + topicID + "-value'></span>";
            ...
            lambdaDiv.setAttribute("style", "padding: 5px; background-color: #e8e8e8; display: inline-block; height: 50px; width: 49%; float: right;");
